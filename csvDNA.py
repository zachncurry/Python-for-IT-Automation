...
def execute_console_commands(
    ...
    # This is acting as though you are actually logging in manually by type usernames, passcodes, and hitting enter into the Telnet session
  full_output = ""
    try:
...
def ping_target_ip(target_ip: str) -> bool:
    # Sends an ICMP ping to the target IP address. Which is why we first had to write the Ping unit
...
def main():
    ...
    with open(CSV_PATH, mode="r", newline="") as file:
        ...
        for row in csv_reader:
            ...
            # Get console info if a console port is specified
            if console_port:
                print(
    ...
    # Display Final Results in a Table Summary
    headers = [
        "TimeStamp",
        "Device Name",
        "CSV IP",
