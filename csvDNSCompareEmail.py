...
######################
#REMEDIATION FUNCTION# Added 7/27/2026
######################
...
def remediation_process(table_device_status):
    ...
    df = pd.DataFrame(
        remediation_table,
        columns=["Time Stamp", "Hostname", "IP Address", "Subnet", "DNS Violation"]
        )
    ...
    try:
        with smtplib.SMTP(EMAIL_HOST, EMAIL_PORT) as server:
            ...
            print("Email ALERT sent successfully with the following information:")
